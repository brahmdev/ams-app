...
import {Container, Content, Form, Icon, Input, Item, Label, Picker} from "native-base";
            ...
            <ScrollView>
              <Form>
                ...
                <Item floatingLabel disabled>
                  ...
                  <Input value={values['username'] ? values['username'] : ''}/>
                </Item>
                <Item floatingLabel disabled>
                  <Label>Password</Label>
                  <Input value={values['password'] ? values['password'] : ''}/>
                </Item>
                <Item floatingLabel>
                  <Label>Mobile</Label>
